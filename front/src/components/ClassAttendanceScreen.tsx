...
const ClassAttendanceScreen: React.FC = () => {
  ...
  const filteredStudents = useMemo(() => {
    return mockStudents.filter(student => student.groupId === selectedGroupId);
  }, [selectedGroupId]);
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <strong>{filteredStudents.length}</strong> students in {mockGroups.find(g => g.id === selectedGroupId)?.name}
            </div>
            <div style={{
              fontSize: '0.75rem',
